...
public static partial class McpServerBuilderExtensions
{
    ...
    private const string WithInterceptorsRequiresUnreferencedCodeMessage =
        ...
        $"and may not work in Native AOT. Use the generic {nameof(WithInterceptors)} method instead.";
    ...
    /// instance for each. For instance methods, an instance will be constructed for each invocation of the interceptor.
    /// </remarks>
    ...
    /// this method will register those interceptors directly without scanning for methods on <typeparamref name="TInterceptorType"/>.
    /// </para>
    /// </remarks>
    public static IMcpServerBuilder WithInterceptors<[DynamicallyAccessedMembers(
        DynamicallyAccessedMemberTypes.PublicMethods |
    ...
    /// <param name="builder">The builder instance.</param>
    /// <param name="serializerOptions">The serializer options governing interceptor parameter marshalling.</param>
    /// <param name="interceptorAssembly">The assembly to load the types from. If <see langword="null"/>, the calling assembly will be used.</param>
    /// <returns>The builder provided in <paramref name="builder"/>.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="builder"/> is <see langword="null"/>.</exception>
    /// <remarks>
    /// <para>
    ...
    /// <para>
    /// The method automatically handles both static and instance methods. For instance methods, a new instance
    /// of the containing class will be constructed for each invocation of the interceptor.
    /// </para>
    /// <para>
